...
\basicInfo{
  ...
  703-798-5998 \textperiodcentered\
...
\section{Education}
\datedsubsection{\textbf{University of Wisconsin - Madison}, WI, USA}
\textit{Ph.D. Computer Sciences} GPA: 3.85 / 4.0 {Advisor: Professor AnHai Doan} {Aug 2014 -- May 2020 (expected)}
\begin{itemize}
\item Cloudmatcher: Building a hands-off cloud/crowd service for entity matching.
\end{itemize}
\datedsubsection{\textbf{Pt. Ravi Shankar Shukla University}, India}
\textit{B.E.} in Computer Science and Engineering GPA: 8.67 / 10.0 {Fall 2003 -- Spring 2007}
