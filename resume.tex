...
\begin{itemize}
\item \textit{CloudMatcher}: Building a hands-off cloud/crowd service for entity matching.
\end{itemize}
...
Working to deploy and build large scale \textit{CloudMatcher} solution to solve matching problems in the insurance domain.
\begin{itemize}
  \item Deployed \textit{CloudMatcher} as a macro-service to help multiple business teams do entity matching, deduplication, etc.
...
\begin{itemize}
  \item \emph{Entity Matching Meets Data Science: A Progress Report from the Magellan Project}, {SIGMOD'19} \\
Yash Govind, P.Konda, et.al.
