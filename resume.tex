...
\begin{itemize}
\item \textit{CloudMatcher}: Building a Cloud/Crowd based solution to solve problems in Entity Matching (EM) space 
\end{itemize}
...
\begin{itemize}
  ...
  \item Working on the bottlenecks in the end-to-end workflow when the dataset is big and complex (ex., feature extraction, active learning)
